...
CREATE DATABASE IF NOT EXISTS `bdrapidisimo` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bdrapidisimo`;
...
INSERT INTO `solicitud_servicio` (`id`, `descripcionCarga`, `claseCarga`, `tipoCarga`, `categoriaCarga`, `pesoKg`, `fechaHoraPartida`, `fechaHoraLlegada`, `direccionOrigen`, `direccionDestino`, `montoPagar`, `distanciaKm`, `estadoPago`, `TARIFAid`, `CLIENTEid`, `PAGO_SOLICITUDid`) VALUES
	(1, 'Carga1', 'P', 'C', 'AL', 1000.00, '2023-01-01 18:00:00', '2023-01-02 02:00:00', 'DireccionOrigen1', 'DireccionDestino1', 80.00, 150.00, NULL, 1, 1, 1),
	(2, 'Carga2', 'N', 'N', 'MC', 2000.00, '2023-01-02 20:00:00', '2023-01-03 04:00:00', 'DireccionOrigen2', 'DireccionDestino2', 120.00, 200.00, NULL, 2, 2, 2),
	(3, 'Carga3', 'P', 'C', 'AL', 1500.00, '2023-01-03 22:00:00', '2023-01-04 06:00:00', 'DireccionOrigen3', 'DireccionDestino3', 100.00, 180.00, NULL, 3, 3, 3);
