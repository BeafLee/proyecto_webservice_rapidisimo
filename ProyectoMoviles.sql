...
CREATE TABLE SOLICITUD_SERVICIO (
  ...
  PAGO_SOLICITUDid int(10) NOT NULL, 
...
ALTER TABLE ESTADO_VEHICULO ADD CONSTRAINT FKESTADO_VEH890070 FOREIGN KEY (SOLICITUD_SERVICIOid, VEHICULOid, CONDUCTORid) REFERENCES VEHICULO_CONDUCTOR (SOLICITUD_SERVICIOid, VEHICULOid, CONDUCTORid);
