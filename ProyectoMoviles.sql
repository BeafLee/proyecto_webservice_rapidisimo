...
CREATE TABLE SOLICITUD_SERVICIO (
  ...
  ESTADO_SOLICITUDid int(10) NOT NULL, 
...
ALTER TABLE SOLICITUD_SERVICIO ADD CONSTRAINT FKSOLICITUD_814934 FOREIGN KEY (ESTADO_SOLICITUDid) REFERENCES ESTADO_SOLICITUD (id);
